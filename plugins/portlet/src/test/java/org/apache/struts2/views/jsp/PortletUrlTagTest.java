...
public class PortletUrlTagTest extends MockObjectTestCase {
    ...
    public void setUp() throws Exception {
        ...
        mockActionInvocation.stubs().method("getProxy").will(returnValue(
        		(ActionProxy)mockActionProxy.proxy()));
        ...
        contextMap.put(PortletActionConstants.DEFAULT_ACTION_MAP, actionMap);
    ...
    public void testWhenPortletModeDiffersFromCurrentAndNoParametersAreSetRenderTheDefaults()
        ...
        Map paramMap = new HashMap();
        paramMap.put(PortletActionConstants.ACTION_PARAM, new String[]{"/help/defaultHelp"});
        paramMap.put(PortletActionConstants.MODE_PARAM, new String[]{mode.toString()});
